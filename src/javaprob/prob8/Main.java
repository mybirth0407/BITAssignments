...
public class Main {
    ...
    static void doCancel() throws IOException {
        ...
        if (ts.cancelReservation(customer_name) == true) {
            System.out.println("Cancelled");
        }
        else {
            System.out.println(customer_name + " is not reserved");
        }
    }
    ...
    static void doCount() throws IOException {
        ...
        if (Integer.parseInt(id) <= 3) {
            System.out.println("Reserved count: " +
                ts.reservedCount(Integer.parseInt(id)));
        }
        else {
